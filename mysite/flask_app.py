...
def home(test=False):
    if request.method == 'POST' or test is True:
        ...
        if not requestEmpty or test is True:
            if test is not True:
                ...
                set1 = pd.read_csv("/tmp/set1.csv", index_col=0)
                set2 = pd.read_csv("/tmp/set2.csv", index_col=0)


            else:
                set1 = pd.read_csv("/home/psicorrespondence/mysite/testfiles/Bergamo.csv", index_col=0)
                set2 = pd.read_csv("/home/psicorrespondence/mysite/testfiles/Desio.csv", index_col=0)
    ...
    return render_template("reprdeg.html")
